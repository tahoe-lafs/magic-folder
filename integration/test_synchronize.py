...
def test_internal_inconsistency(request, reactor, temp_filepath, alice, bob, take_snapshot):
    ...
    yield take_snapshot(alice, "internal", "fluffy")
...
def test_ancestors(request, reactor, temp_filepath, alice, bob, take_snapshot):
    ...
    yield take_snapshot(alice, "ancestor0", "nyan")
    ...
    yield take_snapshot(bob, "ancestor1", "nyan")
...
def test_recover_twice(request, reactor, temp_filepath, alice, bob, edmond, take_snapshot):
    ...
    yield take_snapshot(alice, "original", "pussyfoot")
    ...
    yield take_snapshot(bob, "recovery", "pussyfoot")
...
def test_unscanned_conflict(request, reactor, temp_filepath, alice, bob, take_snapshot):
    ...
    yield take_snapshot(alice, "original", "cheshire")
...
def test_unscanned_vs_old(request, reactor, temp_filepath, alice, bob, take_snapshot):
    ...
    yield take_snapshot(alice, "original", "claude")
