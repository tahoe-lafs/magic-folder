...
from magic_folder._vendor.allmydata.storage.common import si_a2b, si_b2a
from magic_folder._vendor.allmydata.util import base32, hashutil
from magic_folder._vendor.allmydata.util.assertutil import _assert
from magic_folder._vendor.allmydata.interfaces import IURI, IDirnodeURI, IFileURI, IImmutableFileURI, \
