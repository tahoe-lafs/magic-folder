...
# Get a new, awesome version of pip and wheel.  For example, the
# distro-packaged virtualenv's pip may not know about wheels.  Get the
# newer version of pip *first* in case we have a really old one now
# which can't even install setuptools properly.
